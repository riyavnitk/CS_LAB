...
clc; clear all; close all; %clear all stored variables
...
subplot(3,2,2); stem(finalOutput);
xlabel('Samples'); ylabel('Amplitude');
...
subplot(3,2,4); plot(evenNrzData,oddNrzData,'ro');
